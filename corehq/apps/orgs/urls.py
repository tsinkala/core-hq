...
urlpatterns = patterns('corehq.apps.orgs.views',
    ...
    url(r'^(?P<org>[\w\.-]+)/(?P<domain>[\w\.-]+)/remove_project/$', 'orgs_remove_domain', name='orgs_remove_domain'),
    ...
    url(r'^(?P<org>[\w\.-]+)/(?P<user_id>[\w\.-]+)/(?P<role_label>[\w\.-]+)/set_org_permissions/$', 'orgs_change_role', name='orgs_change_role'),
